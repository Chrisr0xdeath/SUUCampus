...
public class MagicPath
{
	...
	public Location[] findThePath(CommandSender sender){
		...
		//keep looking while the path isnt found, the list that needs to be checked isnt empty, and the amount that has been looked at is below 10,000 (arbitrary number, could be any. Too large will cause the program to time out, too little wont give enough nodes to find a path)
